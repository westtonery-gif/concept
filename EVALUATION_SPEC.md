...
- **Вне scope этого документа.** Реальный QA Agent (промпт, Schema роли, правила комплаенса —
  ROADMAP Этап 8; контракт полей его вердикта — §8.1, ADR-0034); оценка Output; оценка
