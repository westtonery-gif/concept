...
- **Вне scope.** Реальный QA Agent (промпт, схема вердикта, правила комплаенса — ROADMAP Этап 8);
  доработка по риску с новой версией артефакта (нужно версионирование); оценка Output; оценка
  уверенности; ссылка на критерии; метка времени.
