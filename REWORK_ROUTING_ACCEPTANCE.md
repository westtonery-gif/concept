...
| RWR-02 | rework input | canonical JSON contains exact v1 identity/content, latest QA flags, human instructions and iteration |
...
| RWR-05 | latest review is `PENDING`, `APPROVED` or `REJECTED` | resume does not start rework or call the executor |
